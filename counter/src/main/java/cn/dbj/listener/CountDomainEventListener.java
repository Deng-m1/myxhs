...
public class CountDomainEventListener implements DomainEventListener {
    ...
    public void onMessage(ConsumerRecord<String,String> record){
        ...
        try {
            domainEventConsumer.consume(countChangeEvent);
        } catch (Throwable t) {
            log.error("Failed to listen domain event[{}:{}].", countChangeEvent.getType(), countChangeEvent.getId(), t);
        }
