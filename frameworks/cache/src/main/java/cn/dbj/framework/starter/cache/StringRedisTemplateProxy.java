...
package cn.dbj.framework.starter.cache;
...
import cn.dbj.framework.starter.bases.Singleton;
import cn.dbj.framework.starter.cache.config.RedisDistributedProperties;
import cn.dbj.framework.starter.cache.core.CacheGetFilter;
import cn.dbj.framework.starter.cache.core.CacheGetIfAbsent;
import cn.dbj.framework.starter.cache.core.CacheLoader;
import cn.dbj.framework.starter.cache.toolkit.CacheUtil;
import cn.dbj.framework.starter.cache.toolkit.FastJson2Util;
...
public class StringRedisTemplateProxy implements DistributedCache {
    ...
    /*public <T> T safeHashGet(String key, Class<T> clazz, CacheLoader<T> cacheLoader, long timeout, TimeUnit timeUnit,
