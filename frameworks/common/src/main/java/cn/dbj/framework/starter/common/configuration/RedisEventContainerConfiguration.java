...
import static cn.dbj.framework.starter.common.Constant.MyConstants.REDIS_DOMAIN_EVENT_CONSUMER_GROUP;
...
public class RedisEventContainerConfiguration {
    private final MyRedisProperties mryRedisProperties;
