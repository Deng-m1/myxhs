...
package cn.dbj.framework.starter.log.core;
...
import cn.dbj.framework.starter.log.annotation.ILog;
...
public class ILogPrintAspect {
     ...
     * 打印类或方法上的 {@link ILog}
     */
    @Around("@within(cn.dbj.framework.starter.log.annotation.ILog) || @annotation(cn.dbj.framework.starter.log.annotation.ILog)")
